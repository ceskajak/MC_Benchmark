...
void nChar200()
{
	...
	// Open files
	TFile *fileHE = TFile::Open("../clean200/clean200_HE.root");
	TFile *filePY_Miro = TFile::Open("../clean200/clean200_PY_Miro.root");
	TFile *filePY_original = TFile::Open("../clean200/clean200_PY_original.root");
	...
	leg->SetHeader("p+p@200 GeV, |#eta| < 1, p_{T} > 200 MeV");
	...
	c1->Print("../output/nChar200.png", "png");
}
