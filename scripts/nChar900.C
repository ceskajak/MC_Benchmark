...
void nChar900()
{
	...
	// Open files
	TFile *fileHE = TFile::Open("../clean900/clean900_HE.root");
	TFile *filePY_Miro = TFile::Open("../clean900/clean900_PY_Miro.root");
	TFile *filePY_original = TFile::Open("../clean900/clean900_PY_original.root");
	...
	leg->SetHeader("p+p@900 GeV, |#eta| < 1, p_{T} > 200 MeV");
	...
	c1->Print("../output/nChar900.png", "png");
}
